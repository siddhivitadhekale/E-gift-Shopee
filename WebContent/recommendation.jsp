						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="${allProductList.product_path}" width="200px" height="300px"  alt="" class="pro-image-front">
									<img src="${allProductList.product_path}" width="200px" height="300px" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="ProductDetailsController?action=productDescription&id=${allProductList.product_id}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
								...
								<h4><a>${string2}...</a></h4>
									<div class="info-product-price">
										<span class="item_price">${allProductList.price}</span>
										<del></del>
									</div>
									<a href="ProductDetailsController?action=addToCart&id=${allProductList.product_id}&price=${allProductList.price}&quantity=1" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
							</div>
						</div>
						</c:forEach>
