		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Clothing</label>
						<ul>
						<% String code=(String)session.getAttribute("code"); 
						System.out.println("code on jsp"+code);
						%>
						<%-- <li><a href="ProductDetailsController?action=subCtegoryList&category=<%=session.getAttribute("code")%>">All</a></li> --%>
						<c:forEach items="${subCategoryPojoList}" var="subcategory" varStatus="index">
						<li><a href="ProductDetailsController?action=searchBySubCategory&code=${subcategory.sub_category_code}">${subcategory.sub_category_desc} </a></li>
						</c:forEach>
